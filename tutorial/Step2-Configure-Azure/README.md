...
1. Follow [Connect Azure Active Directory to Identity Authentication Service](https://developers.sap.com/tutorials/cp-ias-azure-ad.html) tutorial to connect Azure Active Directory to Identity Authentication Service. 
